...
(function(){
  ...
  // === C1: CURSOR CUSTOM (dot + ring lerp) ===
  function initCustomCursor(){
    // Inject CSS — hide native cursor pe document, show custom
  ...
  // === C3: 3D CARD TILT (mousemove rotateX/Y) ===
  function init3DTilt(){
  ...
  // === C4: HOVER IMAGE SATURATE + SCALE pe portofoliu ===
  ...
  // === C5: TABS UNDERLINE INDICATOR animat ===
