...
**Problema:** PowerShell scripts cu literale conținând caractere mojibake (`Ä‚`, `È›`, `â€"`) PARSE-EAZĂ GREȘIT și se rup.
...
| Mojibake `Ä‚È›â€"` în content | Encoding broken, folosește JSON extern UTF-8 |
