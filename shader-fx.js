...
(function(){
  ...
  function init(){
    ...
    // Insert canvas as first child of S2
    ...
    // Fragment shader: domain-warped fbm noise + radial gradient + mouse parallax
    const fsSrc = `
      ...
      void main(){
        ...
        // Color palette — i-vory cosmic (teal + purple + magenta)
        vec3 c1 = vec3(0.0, 0.88, 0.75);    // teal accent
        vec3 c2 = vec3(0.48, 0.17, 1.0);    // purple
        vec3 c3 = vec3(0.73, 0.33, 0.85);   // magenta
        vec3 c4 = vec3(0.05, 0.08, 0.18);   // deep navy
